...
export const CrowdFundingProvider = ({ children }) => {
  ...
  // get all campaigns that are listed
  const getCampaigns = async () => {
    ...
    const parsedCampaigns = campaigns.map((campaign, i) => ({
      ...
      deadline: campaign.deadling.toNumber(),
  ...
  //get user campaigns of current user
  ...
  // donate function to donate to campaign id with amount
  ...
  //get array of donations for a campaign
  ...
  const checkWalletConnected = async () => {
    try {
      ...
      console.log("sumting went wrong");
    }
  };
  useEffect(() => {
