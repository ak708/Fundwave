  ...
  return (
    <div className="relative">
      ...
      <div className="relative bg-opacity-75 backgroundMain">
        ...
        <div className="relative px-4 py-16 mx-auto overflow-hidden sm:max-w-xl md:max-w-ful lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
          <div className="flex flex-col items-center justify-between xl:flex-row">
            <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
              <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-white sm:text-5xl sm:leading-none">
                FundWave <br className="hidden md:block" />
                CrowdFund Co.
              </h2>
              <p className="max-w-xl mb-4 text-base text-gray-200 md:text-lg ">
                Fund your dream and art!
              </p>
              <a
                href="/"
                aria-label=""
              ...
              >
                ...
                <svg
                  ...
                  viewBox="0 0 12 12"
                >
                  <path d="M9.707,5.293 l-5-5 A 1,1,0,0,0,3.293,1.707L7.586,6,3.293, 10. 293 a 1,1,0,1,0,1.414,1.414l5-5 A 1,1,0,0,0,9.707,5.293Z" />
                </svg>
              </a>
            </div>
                ...
                <form>
                  <div className="mb-1 sm:mb-2">
                    ...
                    <input
                      ...
                      required
                      type="text"
                      className="flex-grow w-full h-12 mb-2 transition-duration-200 bg-white border border-gray-300 rounded shadow-sm appearance-none focus:border-deep-purple-accent-400 focus:outline-none focus:shadow-outline"
                      id="firstName"
                      name="firstName"
                    />
                  </div>
                  ...
                  <p className="text-xs text-gray-500 sm:text-sm">
                    create a campaign to raise funds for your dream and art!
                  </p>
                </form>
              </div>
            </div>
